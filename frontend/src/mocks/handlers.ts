...
const ppProjects: any[] = [
  { ...ppBase, id: 1, status: 'DONE', wk: 22, date_record: '2026-06-01', product_pn: '1E7D25403001', model: 'Water Level Rice - BBAS', customer: 'Toyota TH', qty: 200, work_order: 'WO-2026-001', pc_prpo: 'DONE', pc_wait: 'DONE', pc_incoming: 'DONE', pc_smt: 'DONE', pc_thr: 'DONE', pc_test: 'DONE', pc_bbas: 'DONE', pc_packing: 'DONE', chk_man: true, chk_mac: true, chk_med: true, chk_mat: true, pd_pcba: true, pd_bbas: true, pd_test: true, pd_start_date: '2026-06-02', pd_finish_date: '2026-06-11', qa_test_rate: '100', qa_finish_date: '2026-06-12', qa_status: 'DONE', store_received: '2026-06-12', expected_date: '2026-06-13', done: true, pd_pic: 'Noi', team_member: 3, ok_per_day: 40, total_ng: 2, total_ok: 198, remark: 'ส่งครบ', created_at: '2026-06-01T08:00:00Z', updated_at: '2026-06-12T08:00:00Z' },
  { ...ppBase, id: 2, status: 'ON_PROCESS', wk: 24, date_record: '2026-06-10', product_pn: '1E6D25234000', model: 'SMARTNAV - BBAS', customer: 'Honda Mfg', qty: 150, work_order: 'WO-2026-002', syn_requestor: 'Ann', produce: 148, pc_prpo: 'DONE', pc_wait: 'DONE', pc_incoming: 'DONE', pc_smt: 'ON_PROCESS', pd_pcba: true, pd_bbas: true, pd_start_date: '2026-06-12', expected_date: '2026-06-20', target_per_day: 25, pd_pic: 'Kiert', team_member: 2, total_ng: 1, total_ok: 147, created_at: '2026-06-10T08:00:00Z', updated_at: '2026-06-14T08:00:00Z' },
  { ...ppBase, id: 3, status: 'DELAY', wk: 23, date_record: '2026-06-05', product_pn: 'MOT-4500', model: 'Motor Drive 4500', customer: 'Denso Corp', qty: 500, work_order: 'WO-2026-003', syn_requestor: 'Beam', produce: 255, pc_prpo: 'DONE', pc_wait: 'DONE', pc_incoming: 'DONE', pc_smt: 'DONE', pc_test: 'DELAY', pd_pcba: true, pd_rma: true, expected_date: '2026-06-12', revised_date: '2026-06-22', target_per_day: 30, qa_test_rate: '100', qa_status: 'ON_PROCESS', pd_pic: 'Run', team_member: 4, total_ng: 5, total_ok: 250, special_request: 'เร่งด่วน ขอ QA ก่อน', remark: 'รอ component', created_at: '2026-06-05T08:00:00Z', updated_at: '2026-06-14T08:00:00Z' },
  { ...ppBase, id: 4, status: 'CANCEL', wk: 25, date_record: '2026-06-13', product_pn: '1E4D26458000', model: 'CM2 Battery - PCBA', customer: 'AISIN', qty: 80, matl_coming: 'Components (Consign)', expected_date: '2026-06-28', pd_pic: 'Au', team_member: 2, remark: 'รอ consign part', created_at: '2026-06-13T08:00:00Z', updated_at: '2026-06-13T08:00:00Z' },
  ...
  { ...ppBase, id: 6, status: 'ON_PROCESS', wk: 24, date_record: '2026-06-11', product_pn: '1E6D25240003', model: 'SMARTNAV V2 - BBAS', customer: 'Honda Mfg', qty: 180, work_order: 'WO-2026-006', syn_requestor: 'Ann', produce: 122, pd_pcba: true, pd_bbas: true, pd_modified: true, pd_start_date: '2026-06-13', expected_date: '2026-06-21', target_per_day: 25, pd_pic: 'Kiert', pic_responsible: 'Wichai', team_member: 2, total_ng: 2, total_ok: 120, st_incoming: true, st_smt: true, created_at: '2026-06-11T08:00:00Z', updated_at: '2026-06-15T08:00:00Z' },
  { ...ppBase, id: 7, status: 'DELAY', wk: 23, date_record: '2026-06-06', product_pn: 'MOT-4600', model: 'Motor Drive 4600', customer: 'Denso Corp', qty: 450, work_order: 'WO-2026-007', wo_name: 'MotorDrive', chk_man: true, pd_pcba: true, expected_date: '2026-06-13', revised_date: '2026-06-23', pd_pic: 'Run', pic_responsible: 'Anucha', team_member: 4, ok_per_day: 28, total_ng: 6, total_ok: 200, st_wait_mat: true, remark: 'รอ FCT tester', created_at: '2026-06-06T08:00:00Z', updated_at: '2026-06-15T08:00:00Z' },
  ...
  { ...ppBase, id: 14, status: 'CANCEL', wk: 27, date_record: '2026-06-18', product_pn: 'GW-7788', model: 'Gateway IoT', customer: 'Huawei', qty: 60, matl_coming: 'Consign components', expected_date: '2026-07-02', pd_pic: 'Poom', pic_responsible: 'Ice', team_member: 1, st_pr_po: true, remark: 'รอ consign', created_at: '2026-06-18T08:00:00Z', updated_at: '2026-06-18T08:00:00Z' },

  // ── ชุดเดโม (id 15–24) — มี process_log ครบทำให้ Gantt เป็นแท่งหลายสี + โชว์สี status_color ใหม่ (ครบทุกสถานะที่เป็นไปได้) ──
  { ...ppBase, id: 15, status: 'DONE', status_color: '', wk: 26, date_record: '2026-06-20', product_pn: 'RAD-ECU-01', model: 'Radar ECU - PCBA', customer: 'Toyota TH', qty: 240, work_order: 'WO-2026-015', syn_requestor: 'Ann', produce: 240, pd_pcba: true, pd_test: true, pd_start_date: '2026-06-20', pd_finish_date: '2026-07-05', qa_test_rate: '100', qa_finish_date: '2026-07-06', qa_status: 'DONE', store_received: '2026-07-06', expected_date: '2026-07-07', done: true, target_per_day: 20, pd_pic: 'Noi', pic_responsible: 'Somchai', team_member: 3, total_ng: 3, total_ok: 237,
    pc_prpo: 'DONE', pc_incoming: 'DONE', pc_smt: 'DONE', pc_test: 'DONE', pc_packing: 'DONE',
    process_log: [
      { date: '2026-06-20', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-24', step: 'pc_incoming', status: 'ON_PROCESS' },
      { date: '2026-06-28', step: 'pc_smt', status: 'DELAY', note: 'รอ stencil' },
      { date: '2026-07-02', step: 'pc_test', status: 'ON_PROCESS' },
      { date: '2026-07-05', step: 'pc_packing', status: 'DONE' },
    ], created_at: '2026-06-20T08:00:00Z', updated_at: '2026-07-06T08:00:00Z' },
  { ...ppBase, id: 16, status: 'ON_PROCESS', status_color: '', wk: 27, date_record: '2026-06-25', product_pn: 'AIR-BAG-22', model: 'Airbag Ctrl - BBAS', customer: 'Denso Corp', qty: 320, work_order: 'WO-2026-016', syn_requestor: 'Beam', produce: 190, pd_pcba: true, pd_bbas: true, pd_start_date: '2026-06-25', expected_date: '2026-07-18', target_per_day: 26, pd_pic: 'Kiert', pic_responsible: 'Wichai', team_member: 4, total_ng: 4, total_ok: 186,
    pc_prpo: 'DONE', pc_wait: 'WAIT', pc_incoming: 'ON_PROCESS', pc_smt: 'ON_PROCESS',
    process_log: [
      { date: '2026-06-25', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-29', step: 'pc_wait', status: 'WAIT', note: 'รอ IC จากซัพพลาย' },
      { date: '2026-07-04', step: 'pc_incoming', status: 'ON_PROCESS' },
      { date: '2026-07-09', step: 'pc_smt', status: 'ON_PROCESS' },
    ], created_at: '2026-06-25T08:00:00Z', updated_at: '2026-07-14T08:00:00Z' },
  { ...ppBase, id: 17, status: 'DELAY', status_color: '', wk: 25, date_record: '2026-06-15', product_pn: 'EV-INV-900', model: 'EV Inverter', customer: 'Honda Mfg', qty: 500, work_order: 'WO-2026-017', syn_requestor: 'Ann', produce: 210, pd_pcba: true, pd_rma: true, pd_start_date: '2026-06-15', expected_date: '2026-07-01', revised_date: '2026-07-20', target_per_day: 30, qa_test_rate: '100', qa_status: 'DELAY', pd_pic: 'Run', pic_responsible: 'Anucha', team_member: 5, total_ng: 12, total_ok: 198, special_request: 'เร่งด่วน', remark: 'เครื่อง SMT เสีย + รอ fixture',
    pc_prpo: 'DONE', pc_incoming: 'ON_PROCESS', pc_smt: 'DELAY', pc_test: 'DELAY',
    process_log: [
      { date: '2026-06-15', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-19', step: 'pc_incoming', status: 'ON_PROCESS' },
      { date: '2026-06-24', step: 'pc_smt', status: 'DELAY', note: 'เครื่อง SMT เสีย' },
      { date: '2026-07-01', step: 'pc_test', status: 'DELAY', note: 'รอ fixture' },
    ], created_at: '2026-06-15T08:00:00Z', updated_at: '2026-07-10T08:00:00Z' },
  { ...ppBase, id: 18, status: 'DONE', status_color: '', wk: 24, date_record: '2026-06-10', product_pn: 'DASH-CL-07', model: 'Dashboard Cluster', customer: 'AISIN', qty: 280, work_order: 'WO-2026-018', syn_requestor: 'Mint', produce: 280, pd_pcba: true, pd_test: true, pd_start_date: '2026-06-10', pd_finish_date: '2026-06-30', qa_test_rate: '100', qa_finish_date: '2026-07-01', qa_status: 'DONE', store_received: '2026-07-01', expected_date: '2026-07-02', done: true, target_per_day: 22, pd_pic: 'Ploy', pic_responsible: 'Kan', team_member: 3, total_ng: 2, total_ok: 278,
    pc_prpo: 'DONE', pc_incoming: 'DONE', pc_smt: 'DONE', pc_test: 'DONE', pc_packing: 'DONE',
    process_log: [
      { date: '2026-06-10', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-14', step: 'pc_incoming', status: 'DONE' },
      { date: '2026-06-20', step: 'pc_smt', status: 'DONE' },
      { date: '2026-06-26', step: 'pc_test', status: 'DONE' },
      { date: '2026-06-30', step: 'pc_packing', status: 'DONE' },
    ], created_at: '2026-06-10T08:00:00Z', updated_at: '2026-07-01T08:00:00Z' },
  { ...ppBase, id: 19, status: 'ON_PROCESS', status_color: '', wk: 28, date_record: '2026-07-01', product_pn: 'ADAS-CAM-3', model: 'ADAS Camera', customer: 'Bosch', qty: 400, work_order: 'WO-2026-019', syn_requestor: 'Beam', produce: 130, pd_pcba: true, pd_test: true, pd_start_date: '2026-07-01', expected_date: '2026-07-22', target_per_day: 28, pd_pic: 'Fern', pic_responsible: 'Guy', team_member: 4, total_ng: 3, total_ok: 127,
    pc_prpo: 'DONE', pc_incoming: 'ON_PROCESS', pc_smt: 'ON_PROCESS',
    process_log: [
      { date: '2026-07-01', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-07-05', step: 'pc_incoming', status: 'ON_PROCESS' },
      { date: '2026-07-10', step: 'pc_smt', status: 'ON_PROCESS' },
    ], created_at: '2026-07-01T08:00:00Z', updated_at: '2026-07-14T08:00:00Z' },
  { ...ppBase, id: 20, status: 'CANCEL', status_color: '', wk: 24, date_record: '2026-06-12', product_pn: 'LEG-PCB-88', model: 'Legacy PCB', customer: 'Panasonic', qty: 100, matl_coming: 'Consign', work_order: 'WO-2026-020', expected_date: '2026-06-28', pd_pic: 'Bank', pic_responsible: 'Ohm', team_member: 2, remark: 'ลูกค้ายกเลิกออเดอร์',
    pc_prpo: 'DONE', pc_wait: 'WAIT', pc_incoming: 'WAIT',
    process_log: [
      { date: '2026-06-12', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-16', step: 'pc_wait', status: 'WAIT', note: 'รอลูกค้ายืนยัน' },
      { date: '2026-06-18', step: 'pc_incoming', status: 'WAIT' },
    ], created_at: '2026-06-12T08:00:00Z', updated_at: '2026-06-18T08:00:00Z' },
  { ...ppBase, id: 21, status: 'ON_PROCESS', status_color: '', wk: 26, date_record: '2026-06-22', product_pn: 'BMS-V2-45', model: 'BMS v2', customer: 'LG Energy', qty: 360, work_order: 'WO-2026-021', syn_requestor: 'Ann', produce: 205, pd_pcba: true, pd_bbas: true, pd_start_date: '2026-06-22', expected_date: '2026-07-19', target_per_day: 24, pd_pic: 'Boss', pic_responsible: 'Ta', team_member: 3, total_ng: 5, total_ok: 200, remark: 'ขาด component ช่วงกลาง',
    pc_prpo: 'DONE', pc_incoming: 'DONE', pc_smt: 'ON_PROCESS', pc_test: 'ON_PROCESS',
    process_log: [
      { date: '2026-06-22', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-27', step: 'pc_incoming', status: 'DONE' },
      { date: '2026-07-02', step: 'pc_smt', status: 'DELAY', note: 'ขาด component' },
      { date: '2026-07-08', step: 'pc_smt', status: 'ON_PROCESS' },
      { date: '2026-07-12', step: 'pc_test', status: 'ON_PROCESS' },
    ], created_at: '2026-06-22T08:00:00Z', updated_at: '2026-07-13T08:00:00Z' },
  { ...ppBase, id: 22, status: 'DELAY', status_color: '', wk: 23, date_record: '2026-06-05', product_pn: 'TEL-UNIT-6', model: 'Telematics Unit', customer: 'Continental', qty: 220, work_order: 'WO-2026-022', syn_requestor: 'Beam', produce: 140, pd_pcba: true, pd_test: true, pd_start_date: '2026-06-05', expected_date: '2026-06-24', revised_date: '2026-07-17', target_per_day: 18, qa_test_rate: '100', qa_status: 'ON_PROCESS', pd_pic: 'Run', pic_responsible: 'Guy', team_member: 3, total_ng: 9, total_ok: 131, remark: 'yield ต่ำช่วง test',
    pc_prpo: 'DONE', pc_incoming: 'DONE', pc_smt: 'ON_PROCESS', pc_test: 'DELAY',
    process_log: [
      { date: '2026-06-05', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-10', step: 'pc_incoming', status: 'DONE' },
      { date: '2026-06-16', step: 'pc_smt', status: 'ON_PROCESS' },
      { date: '2026-06-22', step: 'pc_test', status: 'DELAY', note: 'yield ต่ำ' },
    ], created_at: '2026-06-05T08:00:00Z', updated_at: '2026-07-11T08:00:00Z' },
  { ...ppBase, id: 23, status: 'DONE', status_color: '', wk: 22, date_record: '2026-05-28', product_pn: 'HVAC-CT-11', model: 'HVAC Ctrl', customer: 'Valeo', qty: 500, work_order: 'WO-2026-023', syn_requestor: 'Mint', produce: 500, pd_pcba: true, pd_bbas: true, pd_test: true, pd_start_date: '2026-05-28', pd_finish_date: '2026-06-18', qa_test_rate: '100', qa_finish_date: '2026-06-19', qa_status: 'DONE', store_received: '2026-06-19', expected_date: '2026-06-20', done: true, target_per_day: 30, pd_pic: 'Nan', pic_responsible: 'Jak', team_member: 4, total_ng: 6, total_ok: 494,
    pc_prpo: 'DONE', pc_incoming: 'DONE', pc_smt: 'DONE', pc_test: 'DONE', pc_packing: 'DONE',
    process_log: [
      { date: '2026-05-28', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-06-02', step: 'pc_incoming', status: 'ON_PROCESS' },
      { date: '2026-06-08', step: 'pc_smt', status: 'ON_PROCESS' },
      { date: '2026-06-14', step: 'pc_test', status: 'DONE' },
      { date: '2026-06-18', step: 'pc_packing', status: 'DONE' },
    ], created_at: '2026-05-28T08:00:00Z', updated_at: '2026-06-19T08:00:00Z' },
  { ...ppBase, id: 24, status: 'ON_PROCESS', status_color: '', wk: 28, date_record: '2026-07-03', product_pn: 'STEER-ECU-9', model: 'Steering ECU', customer: 'ZF', qty: 300, work_order: 'WO-2026-024', syn_requestor: 'Ann', produce: 95, pd_pcba: true, pd_start_date: '2026-07-03', expected_date: '2026-07-25', target_per_day: 22, pd_pic: 'Kiert', pic_responsible: 'Ta', team_member: 3, total_ng: 1, total_ok: 94,
    pc_prpo: 'DONE', pc_wait: 'WAIT', pc_incoming: 'ON_PROCESS', pc_smt: 'ON_PROCESS',
    process_log: [
      { date: '2026-07-03', step: 'pc_prpo', status: 'DONE' },
      { date: '2026-07-07', step: 'pc_wait', status: 'WAIT' },
  ...
  ...([
  ...
  ] as const).map(([model, pn, customer, status, , qty, produce, start], i) => {
    const id = 25 + i;
    ...
    return {
      ...ppBase, id, status, status_color: '',   // เดโม: ใช้สีหลักตามสถานะ ไม่ override สีมั่ว
...
export const handlers = [
  ...
  http.get('/api/pp/projects', ({ request }) => {
    ...
    if (g('work_order')) rows = rows.filter(r => (r.work_order || '').toLowerCase().includes(g('work_order')!.toLowerCase()));
