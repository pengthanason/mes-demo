...
let _ppId = 50;
const ppBase = {
  wk: 0, date_record: null, customer: '', produce: 0, syn_requestor: '', work_order: '', wo_name: '', matl_coming: '',
...
const ppProjects: any[] = [
  ...
  { ...ppBase, id: 2, status: 'ON_PROCESS', wk: 24, date_record: '2026-06-10', product_pn: '1E6D25234000', model: 'SMARTNAV - BBAS', customer: 'Honda Mfg', qty: 150, work_order: 'WO-2026-002', syn_requestor: 'Ann', produce: 148, pd_pcba: true, pd_bbas: true, pd_start_date: '2026-06-12', expected_date: '2026-06-20', target_per_day: 25, pd_pic: 'Kiert', team_member: 2, total_ng: 1, total_ok: 147, created_at: '2026-06-10T08:00:00Z', updated_at: '2026-06-14T08:00:00Z' },
  { ...ppBase, id: 3, status: 'LATE', wk: 23, date_record: '2026-06-05', product_pn: 'MOT-4500', model: 'Motor Drive 4500', customer: 'Denso Corp', qty: 500, work_order: 'WO-2026-003', syn_requestor: 'Beam', produce: 255, pd_pcba: true, pd_rma: true, expected_date: '2026-06-12', revised_date: '2026-06-22', target_per_day: 30, qa_test_rate: '100', qa_status: 'ON_PROCESS', pd_pic: 'Run', team_member: 4, total_ng: 5, total_ok: 250, special_request: 'เร่งด่วน ขอ QA ก่อน', remark: 'รอ component', created_at: '2026-06-05T08:00:00Z', updated_at: '2026-06-14T08:00:00Z' },
