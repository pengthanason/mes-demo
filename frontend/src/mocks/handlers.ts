...
const ppProjects: any[] = [
  ...
  { ...ppBase, id: 15, status: 'DONE', status_color: 'PROCESS', wk: 26, date_record: '2026-06-20', product_pn: 'RAD-ECU-01', model: 'Radar ECU - PCBA', customer: 'Toyota TH', qty: 240, work_order: 'WO-2026-015', syn_requestor: 'Ann', produce: 240, pd_pcba: true, pd_test: true, pd_start_date: '2026-06-20', pd_finish_date: '2026-07-05', qa_test_rate: '100', qa_finish_date: '2026-07-06', qa_status: 'DONE', store_received: '2026-07-06', expected_date: '2026-07-07', done: true, target_per_day: 20, pd_pic: 'Noi', pic_responsible: 'Somchai', team_member: 3, total_ng: 3, total_ok: 237,
  ...
  { ...ppBase, id: 20, status: 'CANCEL', status_color: 'BROWN', wk: 24, date_record: '2026-06-12', product_pn: 'LEG-PCB-88', model: 'Legacy PCB', customer: 'Panasonic', qty: 100, matl_coming: 'Consign', work_order: 'WO-2026-020', expected_date: '2026-06-28', pd_pic: 'Bank', pic_responsible: 'Ohm', team_member: 2, remark: 'ลูกค้ายกเลิกออเดอร์',
