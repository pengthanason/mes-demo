...
import { lazyPage } from './lib/lazyPage.ts';
...
const MesAuthPage        = lazyPage(() => import('./pages/MesAuthPage.tsx').then(m => ({ default: m.MesAuthPage })));
const WoDetailPage       = lazyPage(() => import('./pages/WoDetailPage.tsx').then(m => ({ default: m.WoDetailPage })));
const CloseWoPage        = lazyPage(() => import('./pages/CloseWoPage.tsx').then(m => ({ default: m.CloseWoPage })));
const FaiPage             = lazyPage(() => import('./pages/FaiPage.tsx').then(m => ({ default: m.FaiPage })));
const ProductionPlanPage = lazyPage(() => import('./pages/ProductionPlanPage.tsx').then(m => ({ default: m.ProductionPlanPage })));
const ObaPage             = lazyPage(() => import('./pages/ObaPage.tsx').then(m => ({ default: m.ObaPage })));
const FourMChangePage    = lazyPage(() => import('./pages/FourMChangePage.tsx').then(m => ({ default: m.FourMChangePage })));
const CrDetailPage       = lazyPage(() => import('./pages/CrDetailPage.tsx').then(m => ({ default: m.CrDetailPage })));
const QcResultPage       = lazyPage(() => import('./pages/QcResultPage.tsx').then(m => ({ default: m.QcResultPage })));
const QaVerifyPage       = lazyPage(() => import('./pages/QaVerifyPage.tsx').then(m => ({ default: m.QaVerifyPage })));
const NotificationsPage  = lazyPage(() => import('./pages/NotificationsPage.tsx').then(m => ({ default: m.NotificationsPage })));
const AdminPanelPage     = lazyPage(() => import('./pages/AdminPanelPage.tsx').then(m => ({ default: m.AdminPanelPage })));
const JigProjectPage     = lazyPage(() => import('./pages/JigProjectPage.tsx').then(m => ({ default: m.JigProjectPage })));
const JigTestPage        = lazyPage(() => import('./pages/JigTestPage.tsx').then(m => ({ default: m.JigTestPage })));
const DashboardPage      = lazyPage(() => import('./pages/DashboardPage.tsx').then(m => ({ default: m.DashboardPage })));
const IncomingKittingPage = lazyPage(() => import('./pages/IncomingKittingPage.tsx').then(m => ({ default: m.IncomingKittingPage })));
const WorkOrdersPage     = lazyPage(() => import('./pages/WorkOrdersPage.tsx').then(m => ({ default: m.WorkOrdersPage })));
const QcPage              = lazyPage(() => import('./pages/QcPage.tsx').then(m => ({ default: m.QcPage })));
const TraceabilityPage   = lazyPage(() => import('./pages/TraceabilityPage.tsx').then(m => ({ default: m.TraceabilityPage })));
const DriftViewerPage    = lazyPage(() => import('./pages/DriftViewerPage.tsx').then(m => ({ default: m.DriftViewerPage })));
const NotFoundPage       = lazyPage(() => import('./pages/NotFoundPage.tsx').then(m => ({ default: m.NotFoundPage })));
const SettingsPage       = lazyPage(() => import('./pages/SettingsPage.tsx').then(m => ({ default: m.SettingsPage })));
